...
※現在AWSのインスタンスを停止しているためアクセスできません。<br>
<br>
...
宅地建物取引士という国家資格を学習する際、ポモドーロ・テクニックを使用していたことを思い出し、<br>
アプリを作ってみることにしました。<br>
このアプリはRuby on Railsを総合的に復習でき、且つ新技術に挑戦することができると感じました。<br>
また、従来のポモドーロ・テクニックを用いたアプリでは、２５分測り、「◯月◯日に学習した」という記録は<br>
できますが、しっかりアウトプットまでできるアプリはほとんど見つかりませんでした。<br>
見つかっても25分経過してもタイマーが鳴るものは見つかりませんでした。<br>
アラーム機能を搭載し、ポモドーロテクニックにアウトプットを合わせることで自身の求めていたアプリが<br>
完成すると考えました。<br>
<br>
# 使用言語・フレームワーク
